...
int main(){
    ...
    // unordered_map<string, vector<unsigned int>> res;
    int n_threads=reads.size();
    vector<pair<string, vector<unsigned int>>> res(n_threads);
    ...
    //     //     vector<unsigned int> result=mapping_one(reads[i].second,G,g_hash,g_pos,g_len);
    //     //     out<<reads[i].first<<"-------------->";
    //     //     for (auto ind: result){
    //     //         out<<ind<<", ";
    //     // }
    ...
    //     vector<unsigned int> result=mapping_one(reads[th].second,G,g_hash,g_pos,g_len);
    //     res[th]=make_pair(reads[th].first,result);      
    // }
